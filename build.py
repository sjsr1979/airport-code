...
SHARED_CSS = '''
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .carbon-form input, .carbon-form select { width: 100%; padding: 10px 12px; border: 2px solid var(--border); border-radius: 8px; font-size: 14px; font-family: \'Outfit\', sans-serif; color: var(--text); outline: none; transition: border-color 0.2s; }
  ...
  <div class="content">
    ...
    <div class="card">
      ...
      <div class="card-body" style="text-align:center;padding:28px 20px">
        <p style="color:#64748b;font-size:14px;margin-bottom:16px;">Real-time departures and arrivals for {iata}.</p>
        <a href="https://www.flightaware.com/live/airport/{icao}" target="_blank" rel="noopener"
           style="display:inline-flex;align-items:center;gap:6px;background:#1a56db;color:#fff;padding:9px 18px;border-radius:8px;font-weight:600;font-size:13px;text-decoration:none;">
          FlightAware ↗
        </a>
      </div>
    </div>
