      ...
      <div class="card-body">
        ...
        <div class="carbon-form">
          ...
          <div style="display:flex;gap:20px">
            <label style="display:inline-flex;align-items:center;gap:6px;font-size:14px;font-weight:500;cursor:pointer"><input type="radio" name="trip" value="1" checked>&nbsp;One way</label>
            <label style="display:inline-flex;align-items:center;gap:6px;font-size:14px;font-weight:500;cursor:pointer"><input type="radio" name="trip" value="2">&nbsp;Return</label>
          </div>
