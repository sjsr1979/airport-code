...
<head>
  ...
  <style>{SHARED_CSS}
    ...
    .stats-bar {{ display:grid; grid-template-columns:repeat(4,1fr); justify-items:center; gap:16px; padding:32px 24px; background:var(--white); border-bottom:1px solid var(--border); }}
