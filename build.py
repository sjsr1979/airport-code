      ...
      <div class="card-body">
        ...
        <div class="carbon-form">
          ...
          <div style="display:flex;gap:24px;align-items:center">
            <label style="display:flex;align-items:center;gap:8px;font-size:14px;font-weight:500;cursor:pointer;white-space:nowrap"><input type="radio" name="trip" value="1" checked style="flex-shrink:0;width:16px;height:16px"> One way</label>
            <label style="display:flex;align-items:center;gap:8px;font-size:14px;font-weight:500;cursor:pointer;white-space:nowrap"><input type="radio" name="trip" value="2" style="flex-shrink:0;width:16px;height:16px"> Return</label>
          </div>
